...
public class MACrossesConstants {
    ...
    public static final int SMA_OVER_RSI_BAR_COUNT = 10;
    public static final int FAST_SMA_OVER_RSI_BAR_COUNT = 5;
    public static final int MFI_BAR_COUNT = 14;
    public static final int SMA_OVER_MFI_BAR_COUNT = 9;
    public static final int SMA_BAR_COUNT = 9;
    public static final double AVAILABLE_BALANCE_PRECENTAGE = 1;
    ...
    public static final double  OVER_SOLF_THRESHOLD = 60;
    public static final double  OVER_BOUHT
