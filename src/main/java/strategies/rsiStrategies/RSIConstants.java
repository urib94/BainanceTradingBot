...
public class RSIConstants {
	...
	public static final double RSI_EXIT_OPTION_1_SELLING_PERCENTAGE1 = 50;
	public static final double RSI_EXIT_OPTION_1_SELLING_PERCENTAGE2 = 100;
	public static final double RSI_EXIT_OPTION_2_SELLING_PERCENTAGE1 = 40;
	public static final double RSI_EXIT_OPTION_2_SELLING_PERCENTAGE2 = 100;
	public static final double RSI_EXIT_OPTION_3_SELLING_PERCENTAGE = 100;
	public static final double RSI_EXIT_OPTION_4_SELLING_PERCENTAGE = 100;
	...
	public static final double DEFAULT_BUYING_AMOUNT = 10;
