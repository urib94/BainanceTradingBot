...
import com.binance.client.api.impl.utils.UrlParamsBuilder;
import com.binance.client.api.model.ResponseResult;
import com.binance.client.api.model.market.*;
...
class RestApiRequestImpl {
    ...
    RestApiRequest<List<MyTrade>> getAccountTrades(String symbol, String limit) {
