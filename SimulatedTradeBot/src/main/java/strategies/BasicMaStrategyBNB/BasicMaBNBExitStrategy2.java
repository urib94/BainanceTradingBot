...
public class BasicMaBNBExitStrategy2 implements ExitStrategy {
    ...
    public BasicMaBNBExitStrategy2(PositionSide positionSide, double open) {
    ...
    public SellingInstructions run(DataHolder realTimeData) {
        ...
        if (needToSell){
            ...
            switch (positionSide){
                ...
                case SHORT:
                    if (isBullish){
                        return new SellingInstructions(PositionHandler.ClosePositionTypes.CLOSE_SHORT_MARKET, BasicMaBNBConsts.EXIT_2_SELLING_PERCENTAGE);
                    }
                    break;
                case LONG:
                    if (!isBullish){
                        return new SellingInstructions(PositionHandler.ClosePositionTypes.SELL_MARKET, BasicMaBNBConsts.EXIT_2_SELLING_PERCENTAGE);
                    }
                    break;
            }
        }
