...
import strategies.MAStrategies.BasicMaStrategyBNB.BasicMaStrategyCRV.BasicMaCRVExitStrategy1;
import strategies.MAStrategies.BasicMaStrategyBNB.BasicMaStrategyCRV.BasicMaCRVExitStrategy2;
...
public class BasicMaCRVEntryStrategy implements EntryStrategy {
    AccountBalance accountBalance;
    private double requestedBuyingAmount = MACrossesConstants.DEFAULT_BUYING_AMOUNT;
    PositionHandler positionHandler;
    private int leverage = BasicMaCRVConsts.LEVERAGE;

    public BasicMaCRVEntryStrategy(){
    ...
    private PositionHandler buyAndCreatePositionHandler(DataHolder realTimeData, PositionSide positionSide, String symbol){
        ...
        exitStrategies.add(new BasicMaCRVExitStrategy1(positionSide));
        exitStrategies.add(new BasicMaCRVExitStrategy2(positionSide, realTimeData.getOpenPrice(realTimeData.getLastCloseIndex())));
        ...
        if (positionSide == PositionSide.LONG) {
            try {
                ...
                positionHandler = new PositionHandler(buyOrder, exitStrategies, BasicMaCRVConsts.STOP_LOSS_PERCENTAGE, positionSide);
    ...
    private void updateBuyingAmount(String symbol) {
        ...
        requestedBuyingAmount = (balance * BasicMaCRVConsts.AVAILABLE_BALANCE_PERCENTAGE) / 100;
