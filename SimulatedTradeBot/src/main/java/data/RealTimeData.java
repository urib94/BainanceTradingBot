...
import data.CCICIndicator;
import data.StochDIndicator;
...
import simulation.BasicMaConsts;
...
public class RealTimeData{
    ...
    public synchronized DataHolder updateData(CandlestickEvent event){
        ...
        return new DataHolder(highPriceIndicator, lowPriceIndicator, closePriceIndicator, rsiIndicator, macdOverRsiIndicator, bollingerBandsUpperIndicator, bollingerBandsLowerIndicator,
                ...
                closeBollingerBandWidthIndicator , closeBollingerBandsUpperIndicator , closeBollingerBandsLowerIndicator/*, stochDIndicator, stochasticRSIIndicator*/);
    }
...
//        stochasticRSIIndicator = new StochasticRSIIndicator(currData, StochRsiCrosseConstance.RSI_BAR_COUNT, StochRsiCrosseConstance.STOCH_LENGTH);
//        stochDIndicator = new StochDIndicator(stochasticRSIIndicator, StochRsiCrosseConstance.RSI_BAR_COUNT);
