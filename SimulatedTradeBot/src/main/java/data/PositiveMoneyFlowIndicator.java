...
public class PositiveMoneyFlowIndicator extends CachedIndicator<Num> {
    private final Indicator<Num> indicator;
    private final VolumeIndicator volumeIndicator;
    private final int barCount;

    public PositiveMoneyFlowIndicator(BarSeries series, Indicator<Num> indicator, int barCount) {
        super(indicator);
